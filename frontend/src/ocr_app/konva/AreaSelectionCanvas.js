...
const AreaSelectionCanvas = () => {
    ...
    // ========== 5) 矩形管理フック ==========
    const { rects, newRect, croppedImages, setCroppedImages, handleMouseDown, handleMouseMove, handleMouseUp, removeRect, handlePreviewRect, handleCropRect, handleSaveRect, resetRectsAndCrops, } = useRectController(image || null, naturalWidth, naturalHeight, scaledWidth, scaledHeight, questionImageFullPath, optionsImageFullPath, selectedImageType, currentArea, expandMargin // expandMarginを渡す
    );
    // ========== 6) 既存画像の削除 ==========
