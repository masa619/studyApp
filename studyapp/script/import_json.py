...
def import_json_to_db(json_file_path):
    ...
    with transaction.atomic():
        ...
        if created:
            ...
            print(f"Exam '{exam.name}' を更新しました。")
        ...
        for question_data in data:
            ...
            if created:
                ...
                print(f"Question '{question.no}' を更新しました。")
            ...
            for choice_data in question_data.get("choices", []):
                ...
                if created:
                    ...
                    print(f"Choice '{choice.key}' を更新しました。")
...
if __name__ == "__main__":
    # JSONファイルのパスを指定
    json_file_path = Path("/Users/shipro/Projects/StudyApp/quiz/scripts/chatGPT/merged/merged_output_20241203.json")
